...
export default function CollectionEditorPage() {
  ...
  useEffect(() => {
    ...
    const updateEditorScale = () => {
      ...
      const widthRatio = (canvasArea.clientWidth - 24) / displayCanvasWidth;
      const nextScale = Math.min(widthRatio, 1);
  ...
  }, [displayCanvasWidth, isPreviewingTemplate]);
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-4 gap-2 md:hidden">
        ...
        <button
          onClick={() => scrollSectionIntoView(canvasAreaRef)}
          className="rounded-xl border border-neutral-200 bg-white px-3 py-2 text-xs font-medium text-neutral-700 transition hover:bg-neutral-50"
        >
          Canvas
        </button>
